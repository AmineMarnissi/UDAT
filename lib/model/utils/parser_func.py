...
def parse_args():
    ...
    parser.add_argument('--LA_ATT', dest='LA_ATT',
                        help='whether to use local attention',action='store_true')
    parser.add_argument('--MID_ATT', dest='MID_ATT',
                        help='whether to use middle attention',action='store_true')
    ...
    parser.add_argument('--lamd', dest='lamd',
                        help='value of lamd',
                        default=3, type=float)
...
def set_dataset_args(args, test=False):
    if not test:
        if args.dataset == "voc_0712":
            ...
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "cs_person":
            args.imdb_name = "cs_person_2007_train"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "kaist_vis":
            args.imdb_name = "kaist_vis_2007_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "cvc_vis":
            args.imdb_name = "cvc_vis_2007_train"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "kaist_vis_day":
            args.imdb_name = "kaist_vis_2007_trainval_day"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "flir_vis":
            args.imdb_name = "flir_vis_2007_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        ...
        elif args.dataset_t == "kaist_tr":
            args.imdb_name_target = "kaist_tr_2007_trainval"
        elif args.dataset_t == "cvc_tr":
            args.imdb_name_target = "cvc_tr_2007_train"
        elif args.dataset_t == "kaist_tr_day":
            args.imdb_name_target = "kaist_tr_2007_trainval_day"
        elif args.dataset_t == "kaist_vis":
            args.imdb_name_target = "kaist_vis_2007_trainval"
        elif args.dataset_t == "flir_tr":
            args.imdb_name_target = "flir_tr_2007_trainval"
    else:
        if args.dataset_t == "clipart":
        ...
        elif args.dataset_t == "sim":
            args.imdb_name_target = "sim10k_2012_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset_t == "cs_fg":
            ...
            args.imdb_name_target = "kaist_tr_2007_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES','20']
        elif args.dataset_t == "cvc_tr":
            args.imdb_name_target = "cvc_tr_2007_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES','20']
        elif args.dataset_t == "flir_tr":
            args.imdb_name_target = "flir_tr_2007_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES','20']
        elif args.dataset_t == "kaist_vis":
            args.imdb_name_target = "kaist_vis_2007_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES','20']
        elif args.dataset_t == "osu":
            args.imdb_name_target = "osu_2007_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES','20']
